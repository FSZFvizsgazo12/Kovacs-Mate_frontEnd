...
import { ArticleComponent } from './part/novenyek/article/article.component';

@NgModule({
    declarations: [AppComponent, RolunkComponent, NavComponent, NovenyekComponent, RendelesComponent, ArticleComponent],
    imports: [
        BrowserModule,
        AppRoutingModule,
        NgbModule,
